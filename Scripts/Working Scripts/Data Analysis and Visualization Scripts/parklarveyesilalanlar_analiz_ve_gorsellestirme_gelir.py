...
# Istanbul parks and green areas data
...
r1 = st.pearsonr(districts_with_inst_count["yearly_average_household_income"],
...
ax_3.scatter(x=districts_with_inst_count.loc[:, "yearly_average_household_income"],
